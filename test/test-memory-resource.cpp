...
// Closed Issue #2
BOOST_AUTO_TEST_CASE(test_memory_resource_with_pmr_vector_construction_cpu, *boost::unit_test::disabled()) {
...
BOOST_AUTO_TEST_CASE(test_pool_size_memory_resource, *boost::unit_test::disabled()) {
	pmr::delayed_pool_type<pmr::host_resource_type> memory_resource;
